"""
TQC using SB3-Contrib with RL Zoo best hyperparameters
...
def main():
    ...
    if args.save_dir:
        ...
        log_dir = f"runs/sb3_tqc/{args.env_id}/seed_{args.seed}"
    ...
    # Train
    print(f"Training TQC on {args.env_id} for {args.total_timesteps} steps...")
    model.learn(
